                ...
                <div class="form-container">
                    <form action="" method="post" enctype="multipart/form-data" class="register">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="stock" value="<?= $fetch_product['stock']; ?>" class="box" min="0" max="9999" maxlength="10">
                        </div>
                        <div class="input-field">
                            ...
                            <?php if($fetch_product['image'] != ''){?>
                                ...
                                <div class="flex-btn">
                                    ...
                                    <a href="view_product.php" class="btn" style="width:49%;
                                        text-align: center; height: 3rem; margin-top: .7rem;">Go Back</a>
                                </div>
                            <?php } ?>
                        </div>
                        <div class="flex-btn">
